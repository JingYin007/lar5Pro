...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $db->content = '开场后，第32秒，佩顿在朗多投篮时犯规，送给鹈鹕2次罚球机会。第1分35秒，考辛斯妙传，朱-霍勒迪三分远投命中。
                        第7分28秒，佩顿手滑丢球，被考辛斯抢断。
                        鹈鹕对篮板发起疯狂进攻，本节共抢下16个篮板，包括6个前场篮板，其中戴维斯一人就贡献4个篮板球。';
        $db->sort = rand(1,7);
        $db->view = rand(1,7);
        $db->created_at = time();
        $db->updated_at = time();
