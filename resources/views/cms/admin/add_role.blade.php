                    ...
                    @foreach($menus as $vo)
                        <tr>
                            <td class="td-menu-parent td-nav-menu">
                                {{$vo['name']}}
                                <input type="checkbox" class="cb-nav-menu" value="{{$vo['id']}}" lay-skin="switch" lay-text="ON|OFF" checked>
                            </td>
                            <td class="td-menu-child td-nav-menu">
                                @foreach($vo['child'] as $voi)
                                    <input type="checkbox" class="cb-nav-menu" value="{{$voi['id']}}" title="{{$voi['name']}}" checked>
                                @endforeach
                            </td>
                        </tr>
                    @endforeach
