                                ...
                                <div class="table-responsive">
                                    <table class="table project-table">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('admin/img/user2.png')}}" alt="Avatar" class="avatar img-circle"> <a href="#">Michael</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('admin/img/user1.png')}}" alt="Avatar" class="avatar img-circle"> <a href="#">Antonius</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('admin/img/user5.png')}}" alt="Avatar" class="avatar img-circle" /> <a href="#">Jason</a></td>
                                            <td><span class="label label-default">CLOSED</span></td>
                                        </tr>
                                        </tbody>
                                    </table>
